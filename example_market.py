...
if ret != None:   
    while True:
        ...
        if prompt1 == 'v':
            start_time = "17-01-2026 00:00:00"
            end_time = time.time()
            ...
            exch  = 'NFO'
            tsym = 'AXISBANK28JUL26'
            chain = api.get_option_chain(exchange=exch, tradingsymbol=tsym, strikeprice=1340, count=2)
