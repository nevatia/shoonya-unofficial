...
Installing this repo may overwrite your existing norenapi. So to avoid that you are advised to use it in separate environment by downloading and installing to local folder
---
